...
public class InternalInconsistencyException extends AbstractServiceException {
    private static final String CODE = "001-0700";

    private InternalInconsistencyException(final String message,
    ...
    public static class Builder {
        ...
        public InternalInconsistencyException build() {
            return new InternalInconsistencyException(message, cause, additionalInformation, errorMessageKey, errorMessageArgs);
        }
    }
}
