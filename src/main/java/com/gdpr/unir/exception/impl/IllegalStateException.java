...
public class IllegalStateException extends AbstractServiceException {
    private static final String CODE = "001-0400";

    private IllegalStateException(final String message,
    ...
    public static class Builder {
        ...
        public IllegalStateException build() {
            return new IllegalStateException(message, cause, additionalInformation, errorMessageKey, errorMessageArgs);
        }
    }
}
